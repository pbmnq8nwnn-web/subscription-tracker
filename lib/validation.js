// 訂閱資料的驗證與清理規則，POST（新增）與 PUT（編輯）共用，避免兩處改規則漏改一處。

export const VALID_CATEGORIES = ['娛樂', '工具', '雲端', '健康', '新聞', '教育', '其他'];
export const VALID_CYCLES = ['monthly', 'yearly', 'quarterly', 'weekly'];
export const VALID_CURRENCIES = ['TWD', 'USD', 'JPY', 'EUR'];
export const VALID_STATUSES = ['active', 'paused', 'cancelled'];
export const VALID_PLAN_TYPES = ['solo', 'member', 'organizer'];
